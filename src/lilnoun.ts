import {
  ...
  LilNoundersDAOUpdated as LilNoundersDAOUpdatedEvent,
  ...
  NounsDAOUpdated as NounsDAOUpdatedEvent,
...
export function handleLilNoundersDAOUpdated(
  event: LilNoundersDAOUpdatedEvent
): void {
  let entity = new LilNoundersDAOUpdated(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.lilnoundersDAO = event.params.lilnoundersDAO
...
export function handleNounsDAOUpdated(event: NounsDAOUpdatedEvent): void {
  let entity = new NounsDAOUpdated(
    event.transaction.hash.concatI32(event.logIndex.toI32())
  )
  entity.nounsDAO = event.params.nounsDAO
